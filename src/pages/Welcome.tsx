...
const workRoles = [
  ...
  { id: 'dental_lab', title: 'Я зуботехническая лаборатория', subtitle: 'Заказы, производство и сроки', icon: FlaskConical, path: '/login?role=dental_lab' },
  { id: 'medical_lab', title: 'Я медицинская лаборатория', subtitle: 'Исследования, результаты и клиники', icon: FlaskConical, path: '/login?role=medical_lab' },
  { id: 'diagnostic_center', title: 'Я диагностический центр', subtitle: 'Направления, исследования и результаты', icon: ScanLine, path: '/login?role=diagnostic_center' },
