        ...
        <section className="flex flex-1 flex-col pt-[28px] md:justify-center md:pt-0">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.32 }}>
            ...
            <div className="mt-6 flex max-w-[720px] flex-col gap-2 sm:flex-row">
              <button type="button" onClick={() => navigate('/ai')} className="flex min-h-[56px] flex-1 items-center justify-between rounded-2xl bg-dv-gold px-[18px] text-sm font-medium text-dv-gold-on transition-transform active:scale-[0.99]"><span>Попробовать DentVision AI</span><ArrowRight size={19} strokeWidth={1.8} /></button>
