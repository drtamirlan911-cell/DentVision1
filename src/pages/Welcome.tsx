...
import { ArrowRight, Building2, GraduationCap, HeartPulse, Search, ShoppingBag, Stethoscope, BriefcaseBusiness, FlaskConical, Sparkles, Users, CheckCircle2 } from 'lucide-react'
...
const workRoles = [
  ...
  { id: 'lab', title: 'Я лаборатория', subtitle: 'Заказы, производство и сроки', icon: FlaskConical, path: '/login?role=lab' },
] as const
      ...
      <div className="flex min-h-[calc(100dvh-3rem)] w-full max-w-[390px] flex-col md:max-w-5xl">
        ...
        <section className="flex flex-1 flex-col pt-[28px] md:justify-center md:pt-0">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.32 }}>
            ...
            <p className="mt-3 max-w-[720px] text-[13px] leading-[1.5] text-txt-secondary md:text-sm">DentVision связывает пациента, врача, клинику, диагностику, лабораторию, покупки, обучение и работу одним контекстом. AI помогает найти следующий шаг и выполнить его в рамках ваших прав.</p>
