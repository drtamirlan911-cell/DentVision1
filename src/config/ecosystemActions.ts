...
export const ECOSYSTEM_ACTIONS: readonly EcosystemActionDefinition[] = [
  ...
  { id: 'create-diagnostic-referral', label: 'Создать направление', description: 'Подготовить направление на исследование из текущего контекста', service: 'diagnostics', participants: ['professional','clinic'], risk: 'confirm', path: '/diagnostics/referrals/new', intent: 'create_diagnostic_referral', requiresOrganization: true },
  { id: 'review-diagnostic-result', label: 'Разобрать результат', description: 'Открыть результаты исследований и подготовить следующий клинический шаг', service: 'diagnostics', participants: ['professional','clinic','diagnostic_center','patient'], risk: 'read', path: '/diagnostics/results', intent: 'review_diagnostic_result' },
  ...
  { id: 'open-clinical-case', label: 'Открыть клинический кейс', description: 'Перейти в текущий клинический контур лечения', service: 'practice', participants: ['professional','clinic','patient'], risk: 'read', path: '/crm/treatment-plans', intent: 'open_clinical_case', requiresCase: true },
  { id: 'create-treatment-plan', label: 'Подготовить план лечения', description: 'Сформировать черновик плана на основе разрешённого контекста', service: 'practice', participants: ['professional','clinic'], risk: 'draft', path: '/crm/treatment-plans', intent: 'create_treatment_plan', requiresCase: true },
  { id: 'schedule-appointment', label: 'Запланировать визит', description: 'Подготовить запись пациента на следующий этап', service: 'practice', participants: ['professional','clinic','patient'], risk: 'confirm', path: '/crm/schedule', intent: 'schedule_appointment' },
  { id: 'review-finance', label: 'Открыть финансы', description: 'Посмотреть финансовый контур без изменения расчётов', service: 'finance', participants: ['clinic','diagnostic_center','medical_laboratory','dental_laboratory','supplier','academy','patient'], risk: 'read', path: '/crm/cashier', intent: 'review_finance' },
  ...
  { id: 'manage-branch', label: 'Управлять филиалами', description: 'Открыть организационный контур и настройки рабочего пространства', service: 'administration', participants: ['clinic'], risk: 'privileged', path: '/settings', intent: 'manage_branch', requiresOrganization: true },
];
