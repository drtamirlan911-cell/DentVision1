...
const MODULE_LABELS: Record<string, string> = {
  '/crm/patients': 'Пациент',
  '/crm/dental-chart': 'Зубная карта',
  '/crm/treatment-plans': 'План лечения',
  '/crm/lab': 'Зуботехническая лаборатория',
  '/crm/cashier': 'Финансы',
        ...
        <div className="pointer-events-auto w-full max-w-3xl rounded-2xl border border-dv-gold/20 bg-surface-0/95 shadow-2xl shadow-black/20 backdrop-blur-xl">
          ...
          >
            ...
            <span className="min-w-0 flex-1">
              ...
              <span className="block truncate text-[10px] text-txt-muted">{subtitle || 'Единый клинический контекст DentVision'}</span>
            </span>
