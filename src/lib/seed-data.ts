...
// Прайс переехал в service-catalog.ts: 155 позиций справочника — это не
// демо-данные, а рабочий каталог, из которого клиника собирает свой прайс.
// Реэкспорт оставлен, потому что весь фронтенд импортирует ALL_SERVICES
// отсюда через барель utils/constants.
export { ALL_SERVICES, SERVICE_CATEGORIES, findService, servicesForDiagnosis } from './service-catalog';
