...
import { partnerLegalRouter } from './modules/partner-legal/partner-legal.routes.js';
import { legalStubRouter } from './modules/legal/legal-stub.routes.js';
...
app.use('/api/legal', legalStubRouter);
app.use('/api/partner/legal', partnerLegalRouter);
