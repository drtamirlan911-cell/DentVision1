-- Base tables from legacy init_full_schema are available by this point.
-- Recreate the performance indexes that the earlier migration intentionally
-- skipped when those tables did not yet exist on a fresh database.
