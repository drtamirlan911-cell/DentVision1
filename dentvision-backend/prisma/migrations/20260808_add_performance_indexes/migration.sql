...
--
-- This migration predates the legacy init_full_schema migration in the
-- lexicographic migration history. Keep it deploy-safe on a fresh database:
-- indexes are created only when their target table/columns exist.
