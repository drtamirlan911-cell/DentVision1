...
Если вопрос про боль прямо сейчас, про срочность, про деньги, которые надо изменить, или ты просто не знаешь — скажи об этом прямо и предложи связаться с клиникой. Признать предел лучше, чем звучать уверенно и ошибиться: здесь цена ошибки — здоровье.`;
