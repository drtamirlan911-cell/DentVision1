 ...
 *
 * Mirrored verbatim in `src/lib/presentation/beats.ts` for the browser — the
 * two are asserted identical in beatsParity.test.ts. The projects do not share
 * a build, and the frontend needs these types to render.
 */
