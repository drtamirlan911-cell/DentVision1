    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="p-6 space-y-4">
      ...
      <Card padding="md">
        <div className="flex items-center justify-between mb-4">
          <button aria-label="Previous month" onClick={prevMonth} className="p-1.5 rounded-lg hover:bg-surface-1 text-txt-muted"><ChevronLeft size={18} /></button>
          <h2 className="text-base font-bold text-txt-primary">{MONTHS[month]} {year}</h2>
          <button aria-label="Next month" onClick={nextMonth} className="p-1.5 rounded-lg hover:bg-surface-1 text-txt-muted"><ChevronRight size={18} /></button>
        </div>
