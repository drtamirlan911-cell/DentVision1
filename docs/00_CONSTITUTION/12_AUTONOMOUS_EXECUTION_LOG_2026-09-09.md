...
- Base: `main`
- Current implementation checkpoint: `16b90022a3fa7a5365174f08d561eb480ad77e8a`
...
- Shop checkout has an explicit compensation service foundation with CAS-style claiming, atomic stock restoration, persisted restoration markers, and idempotent DentCash reversal.
...
- Added a server-side supplier eligibility invariant and regression tests: only verified/official-partner suppliers may participate in normal checkout; suspended/pending suppliers are rejected.
...
4. Supplier eligibility invariant must be wired into the real checkout route; supplier/order integrity remains P1.
