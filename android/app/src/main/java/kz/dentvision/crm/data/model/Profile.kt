...
data class UserProfile(
    ...
    val name: String = "",
    val homeQuickServices: List<String> = emptyList(),
    val homeAiAutoCollapse: Boolean = true,
)
...
/** Тело `PUT /api/profile` — только присланные поля перезаписываются. */
@Serializable
data class ProfileUpdate(
    ...
    val homeQuickServices: List<String>? = null,
    val homeAiAutoCollapse: Boolean? = null,
)
